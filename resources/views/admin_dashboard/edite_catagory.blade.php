          ...
          @if(session()->has('message'))
           <div class="alert_message">
            ...
            <div class="col-12 mt-5 grid-margin stretch-card">
                  <div class="card">
                  <form action="" method="post" id="creat_catagory" enctype="multipart/form-data">
                    @csrf
                    <div class="form-group" style="border-bottom: 1px solid #6d7a71;">
                      <h2>Create catagory</h2>
                    </div>
                    <div class="form-group">
                      <input type="text" class="form-control" value="{{$edit_target_catagory->catagory_name}}" name="catagory_name" id="" placeholder="Catagory name..">
                    </div>
                    <div class="form-group">
                      <label for="catagory_img">
                        <div class="img_selected">
                          <i class="fa-regular fa-images"></i>
                          <img id="selected_img" src="{{ asset('catagory_img/'.$edit_target_catagory->catagory_picture) }}" alt="">

                        </div>
                        </label>
                      <input type="file" value="" class="form-control" name="catagory_img" id="catagory_img" style="display: none;">
                    </div>
                    
                    <div class="form-group">
                      <input type="text" class="form-control" value="{{$edit_target_catagory->catagory_description}}" name="catagory_description" id="" placeholder="short description..">
                    </div>
                    <!--<div class="form-group">
